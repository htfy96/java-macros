...
package com2.sun.tools.javac.processing;
...
import com2.sun.tools.javac.model.JavacTypes;
import com2.sun.tools.javac.tree.JCTree.*;
import com2.sun.tools.javac.main.JavaCompiler;
 ...
 */
@Version("@(#)JavacProcessingEnvironment.java	1.35 07/06/14")
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
   ...
   public JavacProcessingEnvironment(Context context, Iterable<? extends Processor> processors) {
    ...
    public String toString() {
        return "javac ProcessingEnvironment version @(#)JavacProcessingEnvironment.java	1.35 07/06/14";
    }
