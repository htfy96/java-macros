...
package com2.sun.tools.javac.api;
...
import com2.sun.source.tree.CompilationUnitTree;
import com2.sun.source.tree.Scope;
import com2.sun.source.tree.Tree;
import com2.sun.source.util.SourcePositions;
import com2.sun.source.util.TreePath;
import com2.sun.source.util.Trees;
import com2.sun.tools.javac.code.Symbol.ClassSymbol;
import com2.sun.tools.javac.code.Symbol.TypeSymbol;
import com2.sun.tools.javac.code.Symbol;
import com2.sun.tools.javac.comp.Attr;
import com2.sun.tools.javac.comp.AttrContext;
import com2.sun.tools.javac.comp.Enter;
import com2.sun.tools.javac.comp.Env;
import com2.sun.tools.javac.comp.MemberEnter;
import com2.sun.tools.javac.comp.Resolve;
import com2.sun.tools.javac.model.JavacElements;
import com2.sun.tools.javac.processing.JavacProcessingEnvironment;
import com2.sun.tools.javac.tree.JCTree.*;
import com2.sun.tools.javac.tree.JCTree;
import com2.sun.tools.javac.tree.TreeCopier;
import com2.sun.tools.javac.tree.TreeInfo;
import com2.sun.tools.javac.tree.TreeMaker;
import com2.sun.tools.javac.util.Context;
import com2.sun.tools.javac.util.List;
import com2.sun.tools.javac.util.Log;
import com2.sun.tools.javac.util.Pair;
...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope 
            ...
            Env<AttrContext> env = ((JavacScope) scope).env;
	    return resolve.isAccessible(env, (com2.sun.tools.javac.code.Type)type, (Symbol)member);  
        } else 
            return false;
    }
