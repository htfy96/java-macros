...
package com2.sun.tools.javac.sym;

import com2.sun.tools.javac.api.JavacTaskImpl;
import com2.sun.tools.javac.code.Kinds;
import com2.sun.tools.javac.code.Scope;
import com2.sun.tools.javac.code.Symbol.*;
import com2.sun.tools.javac.code.Symbol;
import com2.sun.tools.javac.code.Attribute;
import com2.sun.tools.javac.code.Symtab;
import com2.sun.tools.javac.code.Type;
import com2.sun.tools.javac.jvm.ClassReader;
import com2.sun.tools.javac.jvm.ClassWriter;
import com2.sun.tools.javac.jvm.Pool;
...
import com2.sun.tools.javac.util.Name;
...
import javax2.annotation.processing.AbstractProcessor;
import javax2.annotation.processing.RoundEnvironment;
import javax2.annotation.processing.SupportedAnnotationTypes;
import javax2.annotation.processing.SupportedOptions;
...
import static javax2.tools.JavaFileObject.Kind.CLASS;
...
public class CreateSymbols extends AbstractProcessor {
    ...
    void createSymbols() throws IOException {
        ...
        com2.sun.tools.javac.main.JavaCompiler compiler =
            com2.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
