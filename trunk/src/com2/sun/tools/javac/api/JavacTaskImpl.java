...
import com2.sun.source.tree.*;
import com2.sun.source.util.*;
import com2.sun.tools.javac.code.*;
import com2.sun.tools.javac.code.Symbol.*;
import com2.sun.tools.javac.comp.*;
import com2.sun.tools.javac.main.*;
import com2.sun.tools.javac.model.*;
...
public class JavacTaskImpl extends JavacTask {
    ...
    private void prepareCompiler() throws IOException {
        if (!used.getAndSet(true)) {
            ...
            com2.sun.tools.javac.parser.DocCommentScanner.Factory.preRegister(context);
