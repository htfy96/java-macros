...
import com2.sun.source.util.TaskEvent;
import com2.sun.source.util.TaskListener;

import com2.sun.tools.javac.util.*;
import com2.sun.tools.javac.code.*;
import com2.sun.tools.javac.tree.*;
import com2.sun.tools.javac.parser.*;
...
import com2.sun.tools.javac.processing.*;
import javax2.annotation.processing.Processor;

import static javax2.tools.StandardLocation.CLASS_OUTPUT;
import static com2.sun.tools.javac.util.ListBuffer.lb;

// TEMP, until we have a more efficient way to save doc comment info
import com2.sun.tools.javac.parser.DocCommentScanner;

import javax2.lang.macro.Macro;
import javax2.lang.macro.MacroFinder;
import javax2.lang.macro.ParserFactory;
...
public class JavaCompiler implements ClassReader.SourceCompleter {
    ...
    protected JCCompilationUnit parse(JavaFileObject filename, CharSequence content) {
        ...
        ParserFactory pf = new ParserFactory(parserFactory, 
                getScannerFactory());
        for (Macro macro: MacroFinder.extractMacros(tree)) {
            macro.apply(pf, tree);
        }
